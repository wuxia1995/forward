$(document).ready(function() {
    ...
    $('#threCol').on('input propertychange',function(){
        $('#confCol').val($("#threCol").val()/100);
    })
    $('#confCol').on('change',function(){
        $('#threCol').val($("#confCol").val()*100);
    })
    ...
    $('#fullpage').fullpage({
        ...
        navigationTooltips:["主页","人脸检测","人脸对比","人脸集合","人脸搜索","联系我们"],//项目导航的 tip
        //navigationColor:'#fff', //项目导航的颜色
        slidesNavigation:true,
        normalScrollElements:"textarea,.code_box3,.code_box4_2,.results_box4,.attribute_text2",
    });
    //导航栏菜单悬浮、点击效果
    ...
    //人脸集合中的左侧代码收缩、展开点击效果
    $(".attribute_title3_4").click(function(){
        var src1="img/index/two/icon-bottom.png";
        var src2="img/index/two/icon-right.png";
        if($(".attribute_img3_4").attr('src')==src1){
            $(".attribute_img3_4").attr('src',src2);
            $(".attribute_text3_4").css('display','none');
            $(".attribute_box3_4").css({'height':'55px','bottom':'69%'});
            $(".code_img3_4").attr('src',src1);
            $(".code_text3_4").css('display','block');
            $(".code_box3_4").css('height','67%');
        }else{
            $(".attribute_img3_4").attr('src',src1);
            $(".attribute_text3_4").css('display','block');
            $(".attribute_box3_4").css({'height':'67%','bottom':'70px'});
            $(".code_img3_4").attr('src',src2);
            $(".code_text3_4").css('display','none');
            $(".code_box3_4").css('height','55px');
        }
    })
    $(".code_title3_4").click(function(){
        var src1="img/index/two/icon-bottom.png";
        var src2="img/index/two/icon-right.png";
        if($(".code_img3_4").attr('src')==src1){
            $(".attribute_img3_4").attr('src',src1);
            $(".attribute_text3_4").css('display','block');
            $(".attribute_box3_4").css({'height':'67%','bottom':'70px'});
            $(".code_img3_4").attr('src',src2);
    ...
    $(".contrast_btn3_4").mouseover(function(){
        $(this).css({"background-color":"white","color":"#00c3bb"});
    })
    $(".contrast_btn3_4").mouseout(function(){
        $(this).css({"background-color":"#00c3bb","color":"white"});
    })
    ...
    $(".detect_btn3_4").mouseover(function(){
        $(this).css({"background-color":"white","color":"#00c3bb"});
    })
    $(".detect_btn3_4").mouseout(function(){
        $(this).css({"background-color":"#00c3bb","color":"white"});
    })
    ...
    //人脸集合小图片点击效果
    $(".detect_fiveimg3_4").click(function(){
        var minsrc=$(this).children().attr("src");
        $(this).siblings().children().removeClass("img_active");
        $(this).children().addClass("img_active");
        $(this).parents(".upload_box3_4").siblings(".results_maxbox3_4").find(".showcasing_img3_4").attr('src',minsrc);
    })
    //人脸搜索小图片点击效果
